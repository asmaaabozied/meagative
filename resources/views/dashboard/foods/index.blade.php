        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.foods') </h3>

                    <form action="{{ route('dashboard.foods.index') }}" method="get">

                        <div class="row">

                            <div class="col-md-4">
                                @if (auth()->user()->hasPermission('create_typevenues'))
                                    <a href="{{ route('dashboard.foods.create') }}" class="btn btn-primary"><i
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                @if (auth()->user()->hasPermission('update_typevenues'))
                                                    <a href="{{ route('dashboard.foods.edit', $type->id) }}"
                                                ...
                                                @if (auth()->user()->hasPermission('update_typevenues'))
                                                    <form
                                                        action="{{ route('dashboard.foods.block', $type->id) }}"
                                                ...
                                                @if (auth()->user()->hasPermission('delete_typevenues'))
                                                    <form
                                                        action="{{ route('dashboard.foods.destroy', $type->id) }}"
                                                        method="post" style="display: inline-block">
                                                        {{ csrf_field() }}
                                                        {{ method_field('delete') }}
