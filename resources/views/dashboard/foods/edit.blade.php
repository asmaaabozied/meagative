                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>@lang('site.edit')  @lang('site.foods')</span>
                            </h5>
                        </div>
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('dashboard.foods.index') }}"> @lang('site.foods') </a>
                                </li>
                                        ...
                                        <div class="card-title">
                                            <div class="row">
                                                ...
                                                <div class="colmd-12">
                                                    ...
                                                    <form action="{{ route('dashboard.foods.update', $type->id) }}"
                                                          method="post"
