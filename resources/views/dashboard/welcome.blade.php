                                    ...
                                    <div class="card animate fadeLeft">
                                        <div class="card-content cyan white-text">
                                            <p class="card-stats-title"><i
                                                    class="material-icons">person_outline</i> @lang('site.customers')
                                            </p>
                                            <h4 class="card-stats-number white-text count">{{$users}}</h4>
                                ...
                                <div class="col s12 m6 l3">
                                    <div class="card animate fadeLeft">
                                        <div class="card-content red accent-2 white-text">
                                            <p class="card-stats-title"><i
                                                    class="material-icons">photo_filter </i> @lang('site.services')</p>
                                            <h4 class="card-stats-number white-text count">{{$services}}</h4>
                                            <p class="card-stats-compare">
                                ...
                                <div class="col s12 m6 l3">
                                    <div class="card animate fadeRight">
                                        <div class="card-content orange lighten-1 white-text">
                                            <p class="card-stats-title"><i
                                                    class="material-icons">invert_colors</i> @lang('site.halls')</p>
                                            <h4 class="card-stats-number white-text count">{{$halls}}</h4>
                                            <p class="card-stats-compare">
                                                <i class="material-icons">face</i>
                                                <span class="orange-text text-lighten-5">

                                                   @if (auth()->user()->hasPermission('read_halls'))
                                                        <a href="{{ route('dashboard.halls.index') }}"
                                                           style="color: #e2e3e3">@lang('site.read') </a>
                                                    @endif
                                                </span>
                                            </p>
                                ...
                                <div class="col s12 m6 l3">
                                    <div class="card animate fadeRight">
                                        <div class="card-content green lighten-1 white-text">
                                            ...
                                            <h4 class="card-stats-number white-text count">{{$inquires}}</h4>
                                            <p class="card-stats-compare">
                                                <i class="material-icons">face</i>
