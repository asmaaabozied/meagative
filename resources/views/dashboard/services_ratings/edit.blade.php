                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>@lang('site.edit')  @lang('site.services_ratings')</span>
                            </h5>
                        </div>
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('dashboard.services_ratings.index') }}"> @lang('site.services_ratings') </a>
                                </li>
                                <li class="breadcrumb-item"><a
                                    > @lang('site.edit') </a>
                                </li>
                                        ...
                                        <div class="card-title">
                                            <div class="row">
                                                ...
                                                <div class="colmd-12">
                                                    ...
                                                    <form
                                                        action="{{ route('dashboard.services_ratings.update', $type->id) }}"
                                                        method="post"
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <select name="services_id" class="form-control select2">
                                                                    ...
                                                                    @foreach ( $planners as $key=>$customer)
                                                                        <option
                                                                            value="{{$key }}" {{ $type->services_id  == $key? 'selected' : '' }}>
                                                                            {{$customer }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
...
{{--                    </a>--}}
{{--                </li>--}}
{{--                <li><a href="{{ route('dashboard.services_ratings.index') }}"> @lang('site.services_ratings')</a></li>--}}
...
{{--                    <form action="{{ route('dashboard.services_ratings.update', $type->id) }}" method="post"--}}
{{--                          enctype="multipart/form-data">--}}
...
{{--                                <label>@lang('site.start_at')</label>--}}
{{--                                <input type="date" name="datetime" class="form-control date"--}}
{{--                                       value="{{ $type->datetime }}">--}}
{{--                            </div>--}}
...
{{--                                    <option value="">@lang('site.select')</option>--}}
{{--                                    @foreach ( $planners as $key=>$customer)--}}
{{--                                        <option value="{{$key }}" {{ $type->services_id  == $key? 'selected' : '' }}>--}}
{{--                                            {{$customer }}--}}
{{--                                        </option>--}}
{{--                                    @endforeach--}}
{{--                                </select>--}}
