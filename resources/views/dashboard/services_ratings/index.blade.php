        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.services_ratings') </h3>

                    <form action="{{ route('dashboard.services_ratings.index') }}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="{{ route('dashboard.services_ratings.create') }}" class="btn btn-primary"><i
                        ...
                        <table class="table table-hover" id="table">
                            ...
                            @foreach ($types as $index=>$type)
                                <tr>
                                    ...
                                    <td>{{ $lang=='ar'? $type->service->name_ar :$type->service->name_en}}</td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                @if (auth()->user()->hasPermission('update_planers'))
                                                    <a href="{{ route('dashboard.services_ratings.edit', $type->id) }}"
                                                ...
                                                <br>
                                                    @if (auth()->user()->hasPermission('update_planers'))
                                                    <form action="{{ route('dashboard.services_ratings.block', $type->id) }}"
                                                ...
                                                <br>
                                                    ...
                                                    <form
                                                        action="{{ route('dashboard.services_ratings.destroy', $type->id) }}"
                                                        method="post" style="display: inline-block">
                                                        {{ csrf_field() }}
                                                        {{ method_field('delete') }}
