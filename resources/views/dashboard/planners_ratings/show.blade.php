                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>@lang('site.show')  @lang('site.planners_ratings')</span>
                            </h5>
                        </div>
                                                    ...
                                                    @include('partials._errors')
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="text" name="datetime" class="form-control date" value="{{ $type->datetime }}">
                                                            </div>
