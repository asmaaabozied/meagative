        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header with-border">
                    ...
                    <h3 class="box-title" style="margin-bottom: 15px">@lang('site.requirements') </h3>

                    <form action="{{ route('dashboard.requirements.index') }}" method="get">

                        <div class="row">

                            <div class="col-md-4">
                                @if (auth()->user()->hasPermission('create_typevenues'))
                                    <a href="{{ route('dashboard.requirements.create') }}" class="btn btn-primary"><i
                        ...
                        <table class="table table-hover" id="table">
                            ...
                            @foreach ($types as $index=>$type)
                                <tr>
                                    ...
                                    <td>{{ $lang=='ar'? Str::limit($type->description_ar,50) :Str::limit($type->description_en,50)}}</td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                @if (auth()->user()->hasPermission('update_typevenues'))
                                                    <a href="{{ route('dashboard.requirements.edit', $type->id) }}"
                                                ...
                                                @if (auth()->user()->hasPermission('update_typevenues'))
                                                    <form
                                                        action="{{ route('dashboard.requirements.block', $type->id) }}"
                                                ...
                                                @if (auth()->user()->hasPermission('delete_typevenues'))
                                                    <form
                                                        action="{{ route('dashboard.requirements.destroy', $type->id) }}"
                                                        method="post" style="display: inline-block">
                                                        {{ csrf_field() }}
                                                        {{ method_field('delete') }}
