                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m6 l6">
                            <h5 class="breadcrumbs-title mt-0 mb-0"><span>@lang('site.add')  @lang('site.dates_off')</span>
                            </h5>
                        </div>
                        <div class="col s12 m6 l6 right-align-md">
                            <ol class="breadcrumbs mb-0">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('dashboard.dates_off.index') }}"> @lang('site.dates_off') </a>
                                </li>
                                        ...
                                        <div class="card-title">
                                            <div class="row">
                                                ...
                                                <div class="colmd-12">
                                                    ...
                                                    <form action="{{ route('dashboard.dates_off.store') }}"
                                                          method="post"
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <select name="venue_id" class="form-control select2">
                                                                    ...
                                                                    @foreach ( $venues as $key=>$venue)
                                                                        <option
                                                                            value="{{$key }}" {{ old('venue_id') == $key? 'selected' : '' }}>
                                                                            {{$venue }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
