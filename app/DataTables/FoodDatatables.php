...
class FoodDatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($model) {
                ...
                $actions .= DTHelper::dtEditButton(route('dashboard.foods.edit', $model->id), trans('site.edit'), $this->getPermissions()['update']);
                $actions .= DTHelper::dtShowButton(route('dashboard.foods.show', $model->id), trans('site.show'), $this->getPermissions()['update']);

                $actions .= DTHelper::dtDeleteButton(route('dashboard.foods.destroy', $model->id), trans('site.delete'), $this->getPermissions()['delete']);
                $actions .= DTHelper::dtBlockActivateButton(route('dashboard.foods.block', $model->id), $model->active, $this->getPermissions()['update']);
     ...
     *
     * @param \App\Models\FoodDatatable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Venues_foods_drink $model)
    {
    ...
    {
        return Venues_foods_drink::all()->count();
    }
