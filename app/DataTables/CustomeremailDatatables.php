...
class CustomeremailDatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($model) {
                ...
                $actions .= DTHelper::dtEditButton(route('dashboard.customers_emails.edit', $model->id), trans('site.edit'), $this->getPermissions()['update']);
                $actions .= DTHelper::dtDeleteButton(route('dashboard.customers_emails.destroy', $model->id), trans('site.delete'), $this->getPermissions()['delete']);
     ...
     */
    public function query(Customers_email $model)
    {
    ...
    {
        return Customers_email::all()->count();
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('identity_type')->title(trans('site.type')),
