...
class Date_offHallDatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($model) {
                ...
                $actions .= DTHelper::dtEditButton(route('dashboard.dates_off.edit', $model->id), trans('site.edit'), $this->getPermissions()['update']);
                $actions .= DTHelper::dtShowButton(route('dashboard.dates_off.show', $model->id), trans('site.show'), $this->getPermissions()['update']);


                $actions .= DTHelper::dtDeleteButton(route('dashboard.dates_off.destroy', $model->id), trans('site.delete'), $this->getPermissions()['delete']);
     ...
     */
    public function query(Venues_dates_off $model)
    {
    ...
    {
        return Venues_dates_off::all()->count();
    }
