...
use App\Models\Serviceratedatatable;
...
class Serviceratedatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('services_id', function ($customer) {

                return $customer->service->name;
            ...
            ->addColumn('action', function ($model) {
                ...
                $actions .= DTHelper::dtEditButton(route('dashboard.services_ratings.edit', $model->id), trans('site.edit'), $this->getPermissions()['update']);
                $actions .= DTHelper::dtShowButton(route('dashboard.services_ratings.show', $model->id), trans('site.show'), $this->getPermissions()['update']);

                $actions .= DTHelper::dtDeleteButton(route('dashboard.services_ratings.destroy', $model->id), trans('site.delete'), $this->getPermissions()['delete']);
                $actions .= DTHelper::dtBlockActivateButton(route('dashboard.services_ratings.block', $model->id), $model->active, $this->getPermissions()['update']);
     ...
     */
    public function query(Service_rating $model)
    {
    ...
    {
        return Service_rating::all()->count();
    }
    ...
    protected function getColumns()
    {
        return [
            Column::make('id'),
            Column::make('services_id')->title(trans('site.services')),
