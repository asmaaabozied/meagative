...
use App\Models\PlannerDatatable;
...
class PlannerDatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('address_en', function ($model) {
                return $model->address;
            })
            ->editColumn('name_en', function ($mod) {
                return $mod->name;
     ...
     */
    public function query(Planner $model)
    {
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('address_en')->title(trans('site.address')),
