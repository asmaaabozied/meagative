...
use App\Models\VenuerateDatatable;
...
class VenuerateDatatables extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function ($model) {
                ...
                $actions .= DTHelper::dtEditButton(route('dashboard.venues_ratings.edit', $model->id), trans('site.edit'), $this->getPermissions()['update']);

                $actions .= DTHelper::dtShowButton(route('dashboard.venues_ratings.show', $model->id), trans('site.show'), $this->getPermissions()['update']);


                $actions .= DTHelper::dtDeleteButton(route('dashboard.venues_ratings.destroy', $model->id), trans('site.delete'), $this->getPermissions()['delete']);
                $actions .= DTHelper::dtBlockActivateButton(route('dashboard.venues_ratings.block', $model->id), $model->active, $this->getPermissions()['update']);
     ...
     */
    public function query(Venues_rating $model)
    {
    ...
    {
        return Venues_rating::all()->count();
    }
